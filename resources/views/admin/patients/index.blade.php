...
@section('content')
    ...
    <!-- Break line or spacing between header and content -->
    <div class="my-6"></div> <!-- You can adjust the margin (my-6) as needed -->
                    ...
                    <tbody>
                        @foreach ($appointments as $appointment)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('admin.patients.updateStatusPatient', $appointment->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('PATCH')
